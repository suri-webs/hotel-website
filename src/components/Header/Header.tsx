...
export default function Header() {
    ...
    return (
        <header className="w-full relative overflow-hidden h-[730px] max-sm:h-[650px] flex flex-col max-sm:justify-center max-sm:items-center justify-end p-[50px]  items-start max-sm:p-[20px]  ">
            ...
            <span className="z-20 flex w-[50%] max-sm:w-full flex-col gap-[30px] max-sm:gap-5 justify-center items-start max-sm:items-center">
                ...
                <button className="w-[30%] max-sm:w-[40%]  cursor-pointer text-white text-[18px] rounded-[10px] h-[45px] bg-[#ffa844f9]">View More</button>
