  ...
  return (
    <section className="min-h-screen w-full flex mb-20 flex-col justify-center p-5 gap-14 items-center">
      ...
      <div className="w-full flex  justify-center items-center">
        <div className="flex flex-wrap w-[90%] items-center gap-[50px]">
          {Rooms.map((item, id) => {
            return (
              <div key={id} className="flex flex-col overflow-hidden h-[450px] w-[400px] border rounded-[8px] gap-3 relative">
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between">
                    <button className="mt-[20px] hover:underline bg-[#ffa844f9] text-xl text-white px-7 py-2 rounded-[8px]">{item.view}</button>
                    <button className="mt-[20px] hover:underline border-2 text-xl border-red-600 text-black px-7 py-2 rounded-[8px]">Book Now</button>
