...
export default function RoomsHeader() {
    return (
        <section className="h-[650px] w-full flex flex-col relative">
            ...
            {/* Dark-overLay */}
            <div className="absolute h-[100%] inset-0 bg-black/50 z-20"></div>
            {/* Contact */}
            <div className="absolute inset-0 z-30 flex flex-col gap-3 text-white justify-center items-center ">
            <h1 className="text-6xl justify-center w-full font-playfair-display text-center flex items-center gap-7 max-sm:text-4xl">Our Rooms & Suites</h1>
