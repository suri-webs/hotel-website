export default function ContactHeader() {
    return (
        <section className="relative w-full flex max-sm:h-[720px] justify-center items-center h-[650px]  bg-cover bg-center bg-no-repeat bg-[url(/images/ContactHeader.jpg)] max-sm:h-[600px]">
